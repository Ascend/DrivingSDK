 ...
 */
#include "subm_sparse_conv3d_grad_tiling.h"
...
{
    SubmSparseConv3dGradTilingData tiling;
    if (context == nullptr) {
    ...
    tiling.set_inchannel(inchannel);
...
static ge::graphStatus SubmSparseConv3dGradInferDataType(gert::InferDataTypeContext *context)
{
...
namespace ops {
class SubmSparseConv3dGrad : public OpDef {
public:
    explicit SubmSparseConv3dGrad(const char* name) : OpDef(name)
    {
        ...
        this->SetInferShape(ge::InferShape)
            .SetInferDataType(ge::SubmSparseConv3dGradInferDataType);
