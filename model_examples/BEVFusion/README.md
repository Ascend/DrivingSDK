...
在 mmdetection3d 目录下创建 pretrained 文件夹，参考 github仓库，下载预训练权重 swint-nuimages-pretrained.pth。此外需要从 support 支撑人员处获取lidar预训练权重，假设其命名epoch_20.pth。最后将两个预训练权重放在 pretrained 文件夹中：
...
|------------------|-----------|-------------------------|------|-------|-------|-------|-------|
| 8p-Atlas 800T A2 | lidar-cam | 0.075                   | FP32 | 6     | 70.2  | 65.89 | 13.91 | 
| 8p-竞品A           | lidar-cam | 0.075                   | FP32 | 6     | 70.44 | 67.11 | 21.62 |
