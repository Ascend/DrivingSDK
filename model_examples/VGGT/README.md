...
- 参考实现：
  ...
  commit_id=8e3d2809c1c93fa27298c290605841d7e876b285
  ```
- 适配昇腾 AI 处理器的实现：
...
- 克隆代码仓到当前目录并使用patch文件
    ...
    cd vggt
    git checkout 8e3d2809c1c93fa27298c290605841d7e876b285
    cp -f ../VGGT_npu.patch .
...
- 下载模型权重，并放置在应用过patch的模型根目录下，下载地址:https://huggingface.co/facebook/VGGT-1B/resolve/main/model.pt。
