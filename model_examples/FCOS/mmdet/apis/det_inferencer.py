...
class DetInferencer(BaseInferencer):
    ...
    # Video and Webcam are currently not supported and
    ...
    # The data format and fields saved in json need further discussion.
    ...
    def pred2dict(self,
        ...
        if 'pred_panoptic_seg' in data_sample:
            if VOID is None:
                raise RuntimeError(
                    'panopticapi is not installed, please install it by: panopticapi')
