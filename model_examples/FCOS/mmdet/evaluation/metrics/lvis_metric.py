...
try:
    ...
    if getattr(lvis, '__version__', '0') >= '10.5.3':
        warnings.warn(
            'mmlvis is deprecated, please install official lvis-api',  # noqa: E501
            UserWarning)
...
class LVISMetric(CocoMetric):
    ...
    def __init__(self,
        ...
        if lvis is None:
            raise RuntimeError(
                'Package lvis is not installed. Please run "pip install lvis-api')
        ...
        if file_client_args is not None:
            raise RuntimeError(
                ...
                'mmdetection/blob/main/configs/_base_/datasets/coco_detection.py'  # noqa: E501
            )
    ...
    # data_batch is no longer needed, consider adjusting the
    #  parameter position
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            if self._lvis_api is None:
                # Need to refactor to support LoadAnnotations
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for metric in self.metrics:
            ...
            # May refactor fast_eval_recall to an independent metric?
            # fast eval recall
