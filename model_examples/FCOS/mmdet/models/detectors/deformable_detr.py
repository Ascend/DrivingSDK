...
class DeformableDETR(DetectionTransformer):
    ...
    End-to-End Object Detection<abs/2010.04159>`_

    Code is modified from the `official github repo
    <fundamentalvision/Deformable-DETR>`_.
    ...
    def pre_decoder(self, memory: Tensor, memory_mask: Tensor,
        ...
        if self.as_two_stage:
            ...
            # See mmdetection/blob/master/mmdet/models/dense_heads/deformable_detr_head.py#L241 # noqa
