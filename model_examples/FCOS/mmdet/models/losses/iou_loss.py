...
def giou_loss(pred: Tensor, target: Tensor, eps: float = 1e-7) -> Tensor:
    ...
    Box Regression<abs/1902.09630>`_.
...
def diou_loss(pred: Tensor, target: Tensor, eps: float = 1e-7) -> Tensor:
    ...
    Learning for Bounding Box Regression abs/1911.08287`_.

    Code is modified from Zzh-tju/DIoU.
...
def ciou_loss(pred: Tensor, target: Tensor, eps: float = 1e-7) -> Tensor:
    ...
    Segmentation<abs/2005.03572>`_.

    Code is modified from Zzh-tju/CIoU.
...
def eiou_loss(pred: Tensor,
    ...
    Localization <abstract/document/9429909>`_

    Code is modified from ShiqiYu/libfacedetection.train.
...
def siou_loss(pred, target, eps=1e-7, neg_gamma=False):
    ...
    for Bounding Box Regression<abs/2205.12740>`_.

    Code is modified from meituan/YOLOv6.
