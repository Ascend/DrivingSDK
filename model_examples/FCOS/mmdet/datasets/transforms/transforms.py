...
class RandomShift(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        if self._random_prob() < self.prob:
            ...
            # support mask and semantic segmentation maps.
...
class Albu(BaseTransform):
    ...
    def transform(self, results: dict) -> Union[dict, None]:
        ...
        # gt_seg_map is not currently supported
    ...
    def _preprocess_results(self, results: dict) -> tuple:
        ...
        # Support mask structure in albu
        ori_masks = None
        if 'masks' in results:
...
class RandomErasing(BaseTransform):
    ...
    def _transform_bboxes(self, results: dict, patches: List[list]) -> None:
        ...
        bboxes = results['gt_bboxes']
        # unify the logic by using operators in BaseBoxes.
...
class CachedMosaic(Mosaic):
    ...
    def transform(self, results: dict) -> dict:
        ...
        # refactor mosaic to reuse these code.
        mosaic_bboxes = []
        mosaic_bboxes_labels = []
        mosaic_ignore_flags = []
        mosaic_masks = []
...
class CachedMixUp(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        # refactor mixup to reuse these code.
