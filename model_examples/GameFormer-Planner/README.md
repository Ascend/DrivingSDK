...
## 快速开始
本任务主要提供**单机8卡**和**4卡**的训练脚本以及**双机16卡**的多机多卡训练脚本。
### 开始训练
...
- 多机多卡：在模型根目录下，运行训练脚本。
    ```
    # 'XX.XX.XX.XX'为主节点的IP地址，例如 '90.90.122.176'；端口号可以换成未被占用的可用端口
...
| Atlas 800T A2 |  16p  |   8192 |   fp32    |  30   | 1.36 | 3.52 | 0.13 | 0.08 | 1.19 | 1.29 |         971          |
| 竞品A         |  4p  |  1024  |   fp32    |  30   | 1.23 | 3.24 | 0.11 | 0.07 | 0.75 | 1.39 |         448          |
| Atlas 800T A2 |  4p  |   1024 |   fp32    |  30   | 1.24 | 3.24 | 0.11 | 0.07 | 0.76 | 1.43 |         644          |
| Atlas 800T A2 |  16p  |   4096 |   fp32    |  30   | 1.17 | 3.10 | 0.10 | 0.69 | 0.69 | 1.28 |         651          |
