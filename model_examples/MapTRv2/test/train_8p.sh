...
bash ./MapTRv2/tools/dist_train.sh ./MapTRv2/projects/configs/maptrv2/maptrv2_nusc_r50_24ep.py ${WORLD_SIZE} \
...
#吞吐量
ActualFPS=$(awk BEGIN'{print ('$BatchSize' * '$WORLD_SIZE') / '$avg_time'}')
# 输出训练精度mAP,需要模型审视修改
