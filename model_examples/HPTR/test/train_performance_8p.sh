...
sed -i '7 s/null/1/'  ./configs/trainer/${Dataset}.yaml
...
sed -i '7 s/1/null/'  ./configs/trainer/${Dataset}.yaml
...
BatchSize=8
DeviceType=$(uname -m)
CaseName=${Network}_${Dataset}_bs${BatchSize}_${WORLD_SIZE}'p'_'perf'
