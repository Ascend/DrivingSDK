...
export SPARSE_DRIVE_PERFORMANCE_FLAG=1
...
nohup bash ./tools/dist_train.sh \
   ...
   ${num_npu} \
   --deterministic > ${output_path_dir}/stage1_train_8p_performance.log 2>&1 &
...
nohup bash ./tools/dist_train.sh \
   ...
   ${num_npu} \
   --deterministic > ${output_path_dir}/stage2_train_8p_performance.log 2>&1 &
