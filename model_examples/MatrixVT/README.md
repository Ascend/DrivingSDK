...
- 安装依赖
  ...
  5. 请参考 [Driving SDK 使用说明](https://gitcode.com/Ascend/DrivingSDK) 编译并安装 `Driving SDK` 包, 参考`从源码安装`章节。
...
| Atlas 800T A2 | 8p | 64 | 0.3275 | 0.4049 | fp16 |
...
1. 报错scikit_learn.libs/libgomp-d22c30c5.so.1.0.0: cannot allocate memory in static TLS block的问题，解决方案为：
