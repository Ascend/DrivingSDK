...
bash ./tools/dist_train.sh ./projects/configs/flashocc/flashocc-r50.py ${NUM_NPU} --work-dir ${OUTPUT_PATH}/work_dir > ${OUTPUT_PATH}/train.log 2>&1 &
wait
...
if [[ ${TOTAL_EPOCHS} == 24 ]]; then
    ...
    bash ./tools/dist_test.sh ./projects/configs/flashocc/flashocc-r50.py ${OUTPUT_PATH}/work_dir/epoch_24.pth ${NUM_NPU} --eval mAP > ${OUTPUT_PATH}/eval_result.log 2>&1 &
    wait
