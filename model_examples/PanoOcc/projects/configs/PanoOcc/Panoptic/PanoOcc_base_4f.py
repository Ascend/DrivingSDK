...
# lidar voxel grid
# [4,4,2] is the 3D Conv stride of the voxel encoder.
...
# For test: use this inference can improve the performance but slow down the inference speed, default is False
HR_TEST = False
...
# Performance
# 0.712 miou | 0.411 mAP | 0.497 NDS
