...
进一步可替换计算融合算子，DrivingSDK仓高性能算子介绍可参考：https://gitcode.com/Ascend/DrivingSDK/blob/branch_v7.2.RC1/docs/api/README.md
常用融合算子举例：
| 算子名 | 使用方式 |
| ------| ---------|
...
```
7. 原始代码中bev_pool_v2算子为cuda代码，需要替换DrivingSDK仓的bev_pool_v3，更加亲和高效，安装DrivingSDK，参考DrivingSDK: https://gitcode.com/Ascend/DrivingSDK/blob/branch_v7.2.RC1/README.md 
