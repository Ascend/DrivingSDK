...
该报错是由于操作系统的GCC版本过高，推荐使用[DrivingSDK仓库README文档](https://gitcode.com/Ascend/DrivingSDK/blob/branch_v7.3.0/README.md)中的建议版本`gcc 10.2`进行编译，或使用[CenterPoint模型README文档](https://gitcode.com/Ascend/DrivingSDK/blob/branch_v7.3.0/model_examples/CenterPoint/README.md)中的建议版本`gcc 7.5`进行编译。
