...
|-----------|-----------|-------------------|-------------------|---------------------|
| master    | x86&aarch64|Python3.9.x,Python3.10.x,Python3.11.x|2.7.1|v2.7.1|
|           |       |Python3.9.x,Python3.10.x,Python3.11.x|2.8.0|v2.8.0|
| branch_v26.0.0    | x86&aarch64|Python3.9.x,Python3.10.x,Python3.11.x|2.7.1|v2.7.1-26.0.0|
|           |       |Python3.9.x,Python3.10.x,Python3.11.x|2.8.0|v2.8.0-26.0.0|
| branch_v7.3.0    | x86&aarch64|Python3.9.x,Python3.10.x,Python3.11.x|2.7.1|v2.7.1-7.3.0|
|           |       |Python3.9.x,Python3.10.x,Python3.11.x|2.8.0|v2.8.0-7.3.0|
