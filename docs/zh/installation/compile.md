...
宿主机上有配套Ascend NPU芯片且已经安装好固件与驱动，请参考[安装指南](https://www.hiascend.com/document/detail/zh/canncommercial/83RC1/softwareinst/instg/instg_0005.html?Mode=PmIns&InstallType=netconda&OS=openEuler&Software=cannToolKit)。宿主机已安装Docker，且Docker网络可用。
...
1. 拉取镜像。
    ...
    > **说明：**
    > - 本文以拉取`8.3.RC1_alpha001-arm64`版本的镜像为例进行演示。
