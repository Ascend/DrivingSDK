...
3. Q：undefined symbol: _ZN2at4_ops4view4callERKNS_6TensorEN3c108ArrayRefIlEE<br>
...
<table align="center">
    ...
    <tr>
        <td align="center"><a href="#6-2">编译优化`torch_npu`时，报错`undefined symbol`</a></td>
    </tr>
    <tr>
...
#### 6.2 编译优化`torch_npu`时，报错：`ImportError：.../torch_npu/lib/libtorch_npu.so: undefined symbol`
