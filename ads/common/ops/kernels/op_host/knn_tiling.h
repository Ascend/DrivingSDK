...
BEGIN_TILING_DATA_DEF(KnnTilingData)
    ...
    TILING_DATA_FIELD_DEF(uint32_t, aligned_big_size);
    TILING_DATA_FIELD_DEF(uint32_t, aligned_small_len);
    TILING_DATA_FIELD_DEF(uint32_t, aligned_small_size);
...
private:
    ...
    uint32_t aligned_big_size = 0;
    uint32_t aligned_small_len = 0;
    uint32_t aligned_small_size = 0;
};
}
