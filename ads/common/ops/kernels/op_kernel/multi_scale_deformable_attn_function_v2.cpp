...
private:
    ...
    DTYPE_VALUE_SPATIAL_SHAPES h, w, x0, y0, x1, y1, valueOffset, weightOffset, dataOffset, locationOffset, moveOffset, batchOffset, dstOffset, srcOffset;
};
